...
by procedures after calls to :meth:`pylabtools.procedures.Procedure.emit`.
...
from pylabtools.ui import get_object_parameters
...
class Record:
    ...
    :meth:`pylabtools.procedures.Procedure.emit`. Records separate data, metadata, and procedure parameters into
